...
## Uwagi
To jest mocno rozbudowana baza pod styl podobny do pokazanych screenow, ale bez gotowych assetow 2D/3D z tamtego projektu.
Jesli chcesz, w kolejnym kroku moge ci to jeszcze przerobic na:
- wersje stricte pod bronie,
- wersje z prawdziwym podgladem modeli przez kamerki i entity preview,
- wersje z trwalym zapisem do bazy,
- wersje pod konkretne itemy z twojego VORP inventory.
